...
<table width="100%" border="0"  CellSpacing=10  align="center" >
    <tbody>
        <tr>          
            <td><?php echo $this->Ajax->link($this->Html->image('regresar.gif', array('width' => '30', 'heigth' => '30', 'alt' => 'Regresar', 'title' => 'Regresar')), array('controller' => 'TitleStudyDocuments', 'action' => 'index', $this->data['TitleStudyDocument']['title_study_id'], $property_id), array('update' => 'content', 'indicator' => 'loading', 'escape' => false)); ?></td>
        </tr>
    </tbody>
</table>
<fieldset >
    <?php echo $this->Form->create("TitleStudyDocument", array('id' => 'formulario', "action" => "edit/" . $this->data['TitleStudyDocument']['id'] . "/" . $property_id)); ?>
    <legend>Edición de Estudio de título</legend>
    <?php echo $this->Form->hidden('TitleStudyDocument.title_study_id'); ?>
    <?php echo $this->Form->hidden('TitleStudyDocument.id') ?>   
