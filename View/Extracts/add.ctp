...
<fieldset>
    <?php echo $this->Form->create("Extract", array('novalidate' => '', 'id' => 'formulario', 'role' => "form", "class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $proyect_id))); ?>
    <?php echo $this->Form->hidden('Extract.proyect_id', array('value' => $proyect_id)); ?>
