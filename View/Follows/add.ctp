...
<fieldset>
    <?php echo $this->Form->create("Follow", array('novalidate' => '', 'id' => 'formulario', 'role' => "form", "class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $proyect_id))); ?>
    <?php echo $this->Form->hidden('Follow.proyect_id', array('value' => $proyect_id)); ?>
    ...
    <hr> 
    <?php
    echo $this->Form->file("Follow.archivo", array('label' => 'Archivo soporte plan de inversión', 'class' => 'form-control',
