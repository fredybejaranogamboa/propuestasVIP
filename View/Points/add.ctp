...
<?php echo $this->Form->create("Point", array('novalidate'=>'','id'=>'formulario','role'=>"form","class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $property_id))); ?>

<fieldset>
    <?php echo $this->Form->hidden('Point.property_id', array('value' => $property_id)); ?>
