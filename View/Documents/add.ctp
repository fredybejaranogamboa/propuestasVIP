...
<fieldset>
    <?php echo $this->Form->create("Document", array("class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $property_id))); ?>
    <?php echo $this->Form->hidden('Document.property_id', array('value' => $property_id)); ?>
