...
<div class="modal-bodyc">
    ...
    echo $this->Form->input("User.email", array('label' => '', 'class' => 'form-control', 'type'=>"email",'required' => '', 'placeholder' => 'Email'));
    ...
    ?>
    <?php echo $this->Form->end(array('label' => "Guardar", 'class' => 'btn btn-success', 'align' => 'center')) ?>
</div>