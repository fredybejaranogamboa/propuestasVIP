...
$str = '<br><br><span style="text-align:center;" >INSTITUTO COLOMBIANO DE DESARROLLO RURAL-INCODER-</span><br>';
...
$pdf->writeHTML($str, true, false, false, false, '');
$pdf->SetFont('Trebuchet', '', 12);
$str = '<span style = "text-align:center;" >EL DIRECTOR TERRITORIAL ' . strtoupper($departamento) . ' DEL INSTITUTO COLOMBIANO DE DESARROLLO RURAL - INCODER, </span><br>';
$pdf->writeHTML($str, true, false, false, false, '');
$pdf->SetFont('Trebuchet', '', 10);


$str = '<span style = "text-align:center;" >En ejercicio de sus facultades legales y en especial las conferidas por los numerales 1 y 2 del artículo 32 del Decreto 3759 de 2009, el numeral 3 del artículo Vigésimo Tercero del Acuerdo No. 344 de fecha 16 de diciembre de 2014, expedido por el Consejo Directivo del INCODER, el artículo primero de la Resolución No. 01596 de fecha 27 de abril de 2015, proferida por el Gerente General del INCODER, y</span><br>';
...
$str.='<span style="text-align:justify;" >Que el marco del Comité Técnico Territorial, mediante acta de fecha ' . $EnLetras->SubValLetra($dia_acta) . " (" . $dia_acta . ') días del mes de ' . $EnLetras->getMontName($resolucion['Resolution']['fecha_acta']) . ' del ' . $anio_acta . ' INCODER, se seleccionó a la autoridad del resguardo  ' . strtoupper($nombre_asociaciones) . ', teniendo en cuenta los requisitos establecidos para estos fines en el Acuerdo 344 de 2014.</span><br><br>';
...
$str.='<span style="text-align:justify;" >Que dentro del procedimiento realizado por el INCODER, la autoridad del resguardo  ' . strtoupper($nombre_asociaciones) . ' presentó el proyecto denominado ' . $nombre_proyecto . ', para ser revisado, formulado, evaluado y determinar su viabilidad y ser cofinanciado con los recursos que para tales efectos les asignara el INCODER.</span><br><br>';
...
$str.='</span><br><br>';
$str.='<span style="text-align:justify;" >Que el  Gerente General del INCODER, conforme a los artículos 9° y 10° de la Ley 489 de 1998, y al artículo 9° del Decreto 3759 de 2009, profirió la Resolución No. 01596 de fecha 27 de abril de 2015, por medio de la cual delegó en las Direcciones Territoriales del Instituto la expedición y suscripción de los actos administrativos relativos a la adjudicación del incentivo de financiación y/o cofinanciación para los proyectos Productivos a través de los mecanismos para la asignación de recursos establecidos en el Acuerdo 344 de 2014 proferido por el Consejo Directivo del INCODER y demás normas que lo adicionen o modifiquen.</span><br><br>';
$str.='<span style="text-align:justify;" >Que de acuerdo con lo establecido en el numeral 3 del artículo Vigésimo Tercero del Acuerdo No. 344 de 2014 y en el artículo primero de la Resolución No. 01596 de fecha 27 de abril de 2015, se procede a efectuar la adjudicación del incentivo para el proyecto antes mencionado.</span><br><br>';
$str.='<span style="text-align:justify;" >Que en mérito de lo expuesto, el Instituto Colombiano de Desarrollo Rural - INCODER, Dirección Territorial del Departamento de(l) ' . strtoupper($departamento) . ',</span><br><br>';
...
$str = '<span style="text-align:justify;" ><b>ARTÍCULO SEGUNDO: Obligaciones de la persona jurídica.</b> Como consecuencia de la adjudicación del incentivo corresponderá a la persona jurídica sin ánimo de lucro las siguientes obligaciones: 1. Formar parte del equipo técnico de vigilancia de la inversión y dar cumplimiento a lo establecido para tales fines en la regulación normativa que expida el INCODER, y garantizar que los beneficiarios que representa cumplan con los requisitos establecidos en el acuerdo 344 de 2014; 2. Notificarse '
        ...
        . 'los organismos de control, el Comité Técnico Territorial, el Comité Supervisor, INCODER o la comunidad, lo requieran; 11. Crear un archivo organizado de los originales del proyecto y sus actividades, con toda la documentación inherente a la ejecución del mismo y mantenerlo disponible, cuando los organismos de control, el Comité Técnico Territorial y Supervisor o el INCODER lo requieran; 12. Resolver las peticiones que les sean '
        . 'presentadas por el INCODER; 13. Suscribir el acta de cierre del proyecto. </span><br><br>';

$str.='<span style="text-align:justify;" ><b>Parágrafo:</b>No obstante el INCODER  se reserva la facultad de realizar la verificación de los requisitos de los beneficiarios hasta la implementación del proyecto, y en caso de encontrar que algún beneficiario no cumple, la persona jurídica deberá reemplazarla por una familia que cumpla con lo establecido en el procedimiento estatuido por el INCODER.</span><br><br>';

$str.='<span style="text-align:justify;" ><b>ARTÍCULO TERCERO: Familias asociadas al proyecto productivo: </b>El proyecto denominado “' . $nombre_proyecto . '” está orientado a beneficiar a las personas naturales que se relacionan en el cuadro No. 1, en su condición de integrantes de la autoridad del resguardo , debidamente representados de conformidad con lo establecido en el Acuerdo 344 de 2014 así:</span><br><br>';
...
$str.='<span style="text-align:justify;" ><b>ARTÍCULO SEXTO: Conformación del Equipo Técnico de vigilancia de la Inversión.</b>El Equipo Técnico de vigilancia de  la Inversión se conformará por el Director Territorial del INCODER, un representante de la Gobernación del Departamento de(l) ' . strtoupper($departamento) . '; '
...
$str.='<span style="text-align:justify;" ><b>ARTÍCULO DÉCIMO. Notificación. </b>La presente resolución se notificará personalmente a la autoridad del resguardo  ' . strtoupper($nombre_asociaciones) . ' en la forma contemplada en el Código de Procedimiento Administrativo y de lo Contencioso Administrativo, y se comunicará a la Procuraduría Delegada para Asuntos Ambientales y Agrarios.</span><br><br>';
$str.='<span style="text-align:justify;" >Parágrafo: Para la notificación del presente acto administrativo, el representante legal de la autoridad del resguardo  deberá presentar el respectivo certificado de existencia y representación legal con una expedición no mayor de treinta (30) días de expedición y copia de su cédula.</span><br><br>';
