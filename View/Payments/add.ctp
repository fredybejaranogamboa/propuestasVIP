...
<fieldset>
    <?php echo $this->Form->create("Payment", array('novalidate' => '', 'id' => 'formulario', 'role' => "form", "class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $proyect_id))); ?>
    <h3>Datos Pago : <?php echo number_format($cofinanciacion['Evaluation']['cofinanciacion'], 2, ",", ".") ?></h3>
    <div>
        <?php echo $this->Form->hidden('Payment.proyect_id', array('value' => $proyect_id)); ?>
