...
<?php echo $this->Form->create("Property", array('novalidate' => '', 'id' => 'formulario', 'role' => "form", "class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add_property"))); ?>
    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody>
            <tr>
                <td>
                    <?php
                    echo $this->Form->hidden('Property.proyect_id', array('value' => $proyect_id));
