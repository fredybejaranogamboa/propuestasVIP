...
<br><br>
<fieldset>
    <?php echo $this->Form->create("Certification", array('novalidate' => '', 'id' => 'formulario', 'role' => "form", "class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $payment_id))); ?>
    <h3>Datos Certificación</h3>
    <?php echo $this->Form->hidden('Certification.payment_id', array('value' => $payment_id)); ?>
