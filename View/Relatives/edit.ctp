<fieldset>
    <?php echo $this->Form->create("Relative", array('class' => 'form', "action" => "edit/" . $this->data['Relative']['id'])); ?>
    <legend>3.1 Composición de la familia: </legend>
    <?php echo $this->Form->hidden('Relative.candidate_id', array('empty' => '', 'label' => '')); ?>
    <?php echo $this->Form->hidden('Relative.id', array('empty' => '', 'label' => '',)); ?>
    ...
    <table width="100%" border="0"  CellSpacing=10  align="center" >
        <tbody>
            <tr>          
                <td><?php echo $this->Ajax->link($this->Html->image('regresar.gif', array('width' => '30', 'heigth' => '30', 'alt' => 'Regresar', 'title' => 'Regresar')), array('controller' => 'Relatives', 'action' => 'index', $this->data['Relative']['candidate_id']), array('update' => 'content', 'indicator' => 'loading', 'escape' => false)); ?></td>
            </tr>
        </tbody>
    </table>