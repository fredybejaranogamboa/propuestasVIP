    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="dataTable_wrapper">
                <?php
                echo $this->Form->create('Action', array('novalidate' => '', 'id' => 'formulario', 'role' => "form", "class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "edit", $this->data['Action']['id'])));
