<?php echo $this->Form->create("Service", array('novalidate'=>'','id'=>'formulario','role'=>"form","class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "edit", $this->data['Service']['id']))); ?>

<fieldset>
    <?php echo $this->Form->hidden('Service.property_id'); ?>
