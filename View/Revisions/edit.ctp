...
<fieldset>
    <?php echo $this->Form->create("Revision", array('novalidate'=>'','id'=>'formulario','role'=>"form","class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "edit", $this->data['Revision']['id']))); ?>
    <h3>Datos Revisión</h3>
    <?php echo $this->Form->hidden('Revision.evaluation_id'); ?>
    <?php echo $this->Form->hidden('Revision.id'); ?>
