...
<fieldset>
    <?php echo $this->Form->create("Asociation", array('novalidate'=>'','id'=>'formulario','role'=>"form","class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add"))); ?>
 <h3>Datos asociación</h3>
    ...
    <?php echo $this->Form->input('Asociation.departament_id', array('label' => ' Departamento', 'required' => '', 'class' => 'form-control', 'empty' => 'Seleccione departamento', 'options' => $departaments)); ?>
    <div id="ciudades">
        <?php
    ...
    <table border="0">
        <tbody>
            ...
            <tr>
                ...
                <td><?php
                    echo $this->Form->file('Asociation.resolucion', array('label' => 'Resolución adjudicación', 'class' => 'form-control',
                        'accept' => 'application/pdf',
                        'aria-required' => 'true',
                        'extension' => 'pdf'));
                    ?></td>
