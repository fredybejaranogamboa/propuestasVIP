...
<fieldset>
    <?php echo $this->Form->create("Agreement", array("class" => "form", "id" => "formulario", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "edit", $this->data['Agreement']['id']))); ?>
    <?php echo $this->Form->hidden('Agreement.id'); ?>
