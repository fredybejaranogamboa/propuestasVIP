...
class ArosController extends AclAppController
{
	...
	function admin_update_user_role()
	{
        ...
        function admin_ajax_role_permissions($group_id)
	{
		$role_model_name = Configure :: read('acl.aro.role.model');
	    ...
	    $this->{$role_model_name}->recursive = -1;
	    $roles = $this->{$role_model_name}->find('all', array('conditions'=>array($role_model_name.'.id'=>$group_id), 'order' => $role_display_field, 'contain' => false, 'recursive' => -1));
   ...
   function admin_ajax_role_permissions_index() {
            $this->layout="ajax";
            $role_model_name = Configure :: read('acl.aro.role.model');
        ...
        function admin_role_permissions_index() {
            $role_model_name = Configure :: read('acl.aro.role.model');
