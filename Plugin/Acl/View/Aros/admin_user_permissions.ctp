...
?>
    ...
    echo ' ';
    echo $this->Ajax->submit( 'buscar',array('url'=>array(), 'update'=>'content'));
    echo $this->Form->end();
    echo '<br/>';
    ?>
    ...
    foreach($users as $user)
    {
        ...
        echo '  <td>' . $this->Ajax->link($this->Html->image('/acl/img/design/lock.png'), $link, array('update'=>'content', 'alt' => $title, 'title' => $title, 'escape' => false)) . '</td>';
